...
public class MediumTest
{
    ...
    public void MinPathSumTest_1()
    {
        ...
        var actual = _target.MinPathSum(input);
        var expected = 7;
        Assert.Equal(expected, actual);
    }
    ...
    [InlineData(new int[] { 1, 7, 10, 1, 1, 5 }, 16)]
    public void RobTest(int[] input, int expected)
    {
        var actual = _target.Rob(input);
        Assert.Equal(expected, actual);
    }
}
